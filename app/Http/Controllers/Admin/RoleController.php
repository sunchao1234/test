...
class RoleController extends BaseController
{
     ...
     * @return array
     */
    public function getEdit($id,Request $req)
    {
        $id              = intval($id);
        $adminUsersModel = new AdminUsersModel();
    ...
    public function getGrouprolelist(Request $req){
...
//    public function ()
     ...
     * 用户角色创建
     */
    public function getCreaterole($id){
     ...
     * 编辑用户角色
     */
    public function getGrouproleedit($id){
        $id              = intval($id);
        $adminRoleGroupModel = new AdminRoleGroupModel();
    ...
    public function postGrouproleedit(){
    ...
    public function modTree($list,$pid=0,$level=0,$html='&nbsp;&nbsp;&nbsp;&nbsp;'){
        static $tree = array();
...
//                }
    ...
    public function getSupplierlog(){
        $input = Input::all();
    ...
    public function getLogdetail($id, $from){
        if ($from == 'adminlog') {
