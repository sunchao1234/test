                                            ...
                                            <div class="form-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-xs-12 p_top2">
                                                        ...
                                                        <button type="button" id="upload8" class='btn  btn-info'>上传
                                                        </button>
                                                        <div>
                                                            <a id="upload8-container" style="margin: 5px;float:left">
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-xs-12 p_top2">
                                                        ...
                                                        <button type="button" class='btn  btn-info' id="upload5"
                                                               >上传
                                                        </button>
                                                        <div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-xs-12 p_top2">
                                                        <button type="button" id="upload7" ng-click="upload(7)" class='btn btn-info'>上传
                                                        </button>
                                                        <div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-xs-12 p_top2">
                                                        ...
                                                        <button type="button"  id="upload9" class='btn btn-info'>上传
                                                        </button>
                                                        <div>
                                                            <a id="upload9-container" style="margin: 5px;float:left">
                                                            </a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-xs-12 p_top2">
                                                        ...
                                                        <button type="button"  id="upload6" ng-if="data.is_personal"
