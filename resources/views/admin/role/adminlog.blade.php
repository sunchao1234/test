        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption font-green-haze">
                    ...
                    <span class="caption-subject bold uppercase">后台日志</span>
                    <span class="caption-helper"></span>
                </div>
            </div>
            <form id="layoutmod_list_form mb5" name="layoutmod_list_form" action="{{action('Admin\RoleController@getAdminlog')}}" method="get">
                <div class="panel-body" style="padding:0px;padding-bottom:15px;">
                    ...
                    <div class="col-md-2" style="padding-left: 0px; margin-left:14px;">
                        <input id="start_time" name="start_time" class="form-control" placeholder="请输开始入时间" type="text" value="{{$input['start_time']}}" />
                    </div>
                    ...
                    <div class="col-md-2" style="padding-left: 0px; ">
                        <input id="end_time" name="end_time" class="form-control" placeholder="请输入结束时间" type="text" value="{{$input['end_time']}}" />
                    </div>
                    ...
                    <tbody>
                        <?php foreach ($log_list as $key => $value) { ?>
                            <tr class="onePurchase_list_form_id_<?php echo $value->id; ?>"> <!-- class="info" -->
                                ...
                                <td class="text-center"><?php echo $value->nick_name; ?></td>
                                <td class="text-center"><?php echo $value->log; ?></td>
                                <td class="text-center">
                                    <?php echo date('Y-m-d H:i:s', $value->create_time); ?>
                                </td>
                                <td class="text-center">
                                    <a target="_blank" href="/admin/role/logdetail/<?php echo $value->id; ?>/adminlog" class="btn btn-info btn-rounded"> <i class="fa fa-pencil"></i> 查看</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
